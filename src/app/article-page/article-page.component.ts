...
export class ArticlePageComponent implements OnInit, OnDestroy {
    ...
    public song: Article = {name: '', artist: ''};
    ...
    public delete(): void {
        ...
        modalRef.componentInstance.title = 'Delete Article';
            ...
            lyricsResult => {
                ...
                this.handlePromise(this.database.list('songs').push(this.song),
                    songResult => {
                        ...
                        this.successMessage = 'Article Added!';
                    },
                    () => {
    ...
    private updateSong(): void {
        this.handlePromises([
            this.database.object(`/articles/${this.songKey}`).update({
                ...this.song,
                key: null,
                lastModifiedDate: new Date().toISOString()
            }),
